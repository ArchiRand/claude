...
description: Генерация текста коммита и структурированного описания изменений для команды и QA. Используй когда пользователь просит подготовить не только сообщение коммита, но и описание изменений для MR/QA — в отличие от commit-writer, который генерирует только текст коммита без описания.
...
2. **Идентификатор задачи**: Как правило есть в названии ветки по шаблону: `KA-xxxx`, пример: `KA-28113`
...
- Все тексты на русском, включая текст коммита