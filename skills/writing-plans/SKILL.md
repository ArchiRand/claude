...
Пиши исчерпывающие планы реализации, предполагая что исполнитель не имеет контекста кодовой базы. Документируй всё необходимое: какие файлы трогать в каждой задаче, код/конфиги, шаги тестирования, как верифицировать. Давай весь план мелкими задачами. DRY. YAGNI
