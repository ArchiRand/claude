...
> 1. **writing-plans сейчас** — создам план реализации в текущем контекстном окне.
> 2. **next-stage-prompt** — сгенерирую готовый промпт со ссылкой на спек, чтобы ты вставил его в новый чистый контекст.»
...
- **Сначала найди простейшее решение. Добавляй сложности только когда без нее не получается**
